...
const Footer = () => {
  ...
  const socialLinks = [
    { name: "Facebook", icon: <FaFacebook size={16} />, path: "#" },
    { name: "Instagram", icon: <FaInstagram size={16} />, path: "#" },
    { name: "Twitter", icon: <FaXTwitter size={16} />, path: "#" },
    { name: "WhatsApp", icon: <FaWhatsapp size={16} />, path: "#" },
  ];
    ...
    >
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 relative z-[1]">
        ...
        <div className="flex items-center justify-center gap-1 text-center flex-wrap">
          ...
          <span className="text-sm text-primary-light font-black">متجرنا</span>
        </div>
      </div>
